...
# softplus model
softplus_model = resnet_softplus_08.ResNet18()
softplus_model.load_state_dict(torch.load(args.model_path)["net"])
...
org_expl = get_expl(softplus_model, normalizer.forward(examples), args.method, desired_index=labels)
adv_expl = get_expl(softplus_model, normalizer.forward(perturbation.adversarial_tensors()), args.method,
