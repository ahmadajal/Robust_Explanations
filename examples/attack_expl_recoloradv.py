...
target_expl, _, _ = get_expl(model, normalizer.forward(target_examples), method) # was soft-plus before!!
target_expl = target_expl.detach()
# original explanation and logits
org_expl, _, _ = get_expl(softplus_model, normalizer.forward(examples), method)
...
adv_expl,_,_ = get_expl(softplus_model, normalizer.forward(perturbation.adversarial_tensors()), method, desired_index=labels)
