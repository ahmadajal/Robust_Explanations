...
# python attack_expl_cifar.py --output_dir output_expl_cifar/CURE/add_stadv/ --attack_type 0 1 1 --method "saliency" --model_path "../notebooks/models/RN18_CURE.pth" | tee -a output_expl_cifar/CURE/add_stadv/output.log
#
...
# python attack_expl_cifar.py --output_dir output_expl_cifar/CURE/add_recolor/ --attack_type 1 0 1 --method "saliency" --model_path "../notebooks/models/RN18_CURE.pth" | tee -a output_expl_cifar/CURE/add_recolor/output.log
#
...
# python attack_expl_cifar.py --output_dir output_expl_cifar/CURE/add_stadv_recolor/ --attack_type 1 1 1 --method "saliency" --model_path "../notebooks/models/RN18_CURE.pth" | tee -a output_expl_cifar/CURE/add_stadv_recolor/output.log
#######################################################
...
# python attack_expl_cifar.py --output_dir output_expl_cifar/CURE/add_l1/ --attack_type 0 0 1 --method "saliency" --model_path "../notebooks/models/RN18_CURE.pth" --additive_lp_bound 100.0 | tee -a output_expl_cifar/CURE/add_l1/output.log
#########################################################
...
# python attack_expl_cifar.py --output_dir output_expl_cifar/adv_train_RN50/add/ --attack_type 0 0 1 --method "saliency" --model_path "../notebooks/models/RN50_linf_8_model_only.pt" | tee -a output_expl_cifar/adv_train_RN50/add/output.log
# #
...
# python attack_expl_cifar.py --output_dir output_expl_cifar/adv_train_RN50/add_stadv/ --attack_type 0 1 1 --method "saliency" --model_path "../notebooks/models/RN50_linf_8_model_only.pt" | tee -a output_expl_cifar/adv_train_RN50/add_stadv/output.log
# #
...
# python attack_expl_cifar.py --output_dir output_expl_cifar/adv_train_RN50/add_stadv_recolor/ --attack_type 1 1 1 --method "saliency" --model_path "../notebooks/models/RN50_linf_8_model_only.pt" | tee -a output_expl_cifar/adv_train_RN50/add_stadv_recolor/output.log
##########################CIEDE##########################
