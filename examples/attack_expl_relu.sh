...
# python attack_expl_relu.py --output_dir output_expl_relu/add/smooth_grad/ --attack_type 0 0 1 --method "saliency" --lr 0.001 --smooth True --additive_lp_bound 0.06 | tee -a output_expl_relu/add/smooth_grad/output.log
#
...
# python attack_expl_relu.py --output_dir output_expl_relu/add_stadv/smooth_grad/ --attack_type 0 1 1 --method "saliency" --smooth True --lr 0.0004 --additive_lp_bound 0.06 --stadv_lp_bound 0.1 --norm_weights 0.5 0.5 0 | tee -a output_expl_relu/add_stadv/smooth_grad/output.log
# #
...
# python attack_expl_relu.py --output_dir output_expl_relu/add_recolor/smooth_grad/ --attack_type 1 0 1 --method "saliency" --smooth True --lr 0.001 --additive_lp_bound 0.06 --norm_weights 0.5 0.5 0 | tee -a output_expl_relu/add_recolor/smooth_grad/output.log
# #
...
# python attack_expl_relu.py --output_dir output_expl_relu/add_stadv_recolor/smooth_grad/ --attack_type 1 1 1 --method "saliency" --smooth True --lr 0.0004 --additive_lp_bound 0.06 --stadv_lp_bound 0.1 --norm_weights 0.5 0.5 0 | tee -a output_expl_relu/add_stadv_recolor/smooth_grad/output.log
# ##########################################################
...
# python attack_expl_relu.py --output_dir output_expl_relu/add/uniform_grad/ --attack_type 0 0 1 --method "uniform_grad" --lr 0.001 --additive_lp_bound 0.06 | tee -a output_expl_relu/add/uniform_grad/output.log
#
...
# python attack_expl_relu.py --output_dir output_expl_relu/add_stadv/uniform_grad/ --attack_type 0 1 1 --method "uniform_grad" --lr 0.0004 --additive_lp_bound 0.06 --stadv_lp_bound 0.1 | tee -a output_expl_relu/add_stadv/uniform_grad/output.log
#
...
# python attack_expl_relu.py --output_dir output_expl_relu/add_recolor/uniform_grad/ --attack_type 1 0 1 --method "uniform_grad" --lr 0.001 --additive_lp_bound 0.06 | tee -a output_expl_relu/add_recolor/uniform_grad/output.log
# #
...
# python attack_expl_relu.py --output_dir output_expl_relu/add_stadv_recolor/uniform_grad/ --attack_type 1 1 1 --method "uniform_grad" --lr 0.0004 --additive_lp_bound 0.06 --stadv_lp_bound 0.1 | tee -a output_expl_relu/add_stadv_recolor/uniform_grad/output.log
##########################################################ciede###########################
...
# python attack_expl_relu.py --output_dir output_expl_relu/ciede/add/smooth_grad/ --attack_type 0 0 1 --method "saliency" --lr 0.001 --smooth True --ciede2000_reg 0.01 --additive_lp_bound 0.2 | tee -a output_expl_relu/ciede/add/smooth_grad/output.log
#
...
# python attack_expl_relu.py --output_dir output_expl_relu/ciede/add/uniform_grad/ --attack_type 0 0 1 --method "uniform_grad" --lr 0.001 --ciede2000_reg 0.01 --additive_lp_bound 0.2 | tee -a output_expl_relu/ciede/add/uniform_grad/output.log
#
